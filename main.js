const jpFlag = document.querySelector(".jpLang");
const koFlag = document.querySelector(".koLang");
...
koButton.addEventListener("click", function () {
  ...
  jpFlag.classList.remove("hidden5");
  koFlag.classList.add("hidden5");
});
...
jaButton.addEventListener("click", function () {
  ...
  jpFlag.classList.add("hidden5");
  koFlag.classList.remove("hidden5");
});
